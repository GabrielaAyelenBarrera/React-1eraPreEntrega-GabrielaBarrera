        ...
        <div className="container my-5">
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ?
                        <div>
                            <div className="alert alert-light" role="alert">¡Gracias por tu compra! Tu número de seguimiento es: <b>{orderId}</b></div>
                            <Link to={"/"} className="btn text-white bg-dark rounded-0 my-3">Volver a la Página Principal</Link>
                        </div> : ""}
                </div>
            </div>
        </div>
